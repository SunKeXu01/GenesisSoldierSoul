...
public class vp_FPWeapon : vp_Weapon
{
	...
	protected Animation m_WeaponModelAnimation;
	...
	public bool DoSpringsInLateUpdate;
	...
	public GameObject WeaponCamera
	{
		get
		{
			return m_WeaponCamera.gameObject;
		}
	}
	...
	protected override void Awake()
	{
		...
		{
			camera = item.GetComponent<Camera>();
			if (camera != null)
			{
				m_WeaponCamera = camera;
				break;
			}
		}
	...
	protected override void Start()
	{
		...
		material.color = new Color(0.15f, 0.15f, 1f, 0.5f);
	...
	protected virtual void UpdateZoom()
	{
		if (!(m_FinalZoomTime <= Time.time) && m_Wielded)
		{
			...
			if (m_WeaponCamera != null && vp_Utility.IsActive(m_WeaponCamera.gameObject))
			{
				m_WeaponCamera.fieldOfView = Mathf.SmoothStep(m_WeaponCamera.fieldOfView, RenderingFieldOfView, t);
			}
		}
	}
	...
	protected virtual void UpdateRetraction(bool firstIteration = true)
	{
		if (RetractionDistance != 0f)
		{
			...
			RaycastHit hitInfo;
			if (Physics.Linecast(vector, end, out hitInfo, vp_Layer.Mask.ExternalBlockers) && !hitInfo.collider.isTrigger)
			{
	...
	public override void Wield(bool isWielding = true)
	{
		...
		if ((isWielding ? AnimationWield : AnimationUnWield) != null && vp_Utility.IsActive(base.gameObject) && m_WeaponModelAnimation != null)
		{
			if (isWielding)
			{
	...
	public virtual void ScheduleAmbientAnimation()
	{
		...
		{
			if (this != null && base.gameObject != null && vp_Utility.IsActive(base.gameObject) && m_WeaponModelAnimation != null)
			{
