...
- 工具：`tools/recover_private_rez_framed_prefix.py`，当前 tool version 13（world v85 首次纳入于 version 7）。
...
- 全量 Python 回归 100/100；快速交付门禁通过。统一 provenance 复核 13/13 清单、185,381 个输出、25,517,717,171 字节，错误 0。

REZ 已无从数据区起点完全未知的包；剩余范围为 RF019/RF199 的 4 个和 RB001 的 1 个已精确记录停止位置的未知后缀。

2026-08-09 后续已通过 zero-mirror 与 RB001 加密目录 MD5 将上述尾段全部闭合为 0。
